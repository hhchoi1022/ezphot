...
#%%
from ezphot.image import *
from ezphot.photometry import TIPSubtraction, Stack, AperturePhotometry, TIPProjection
from ezphot.utils import *
from ezphot.helper import Helper, DataBrowser
import numpy as np
#%%
tile_id = 'T22956'
...
dbrowser.telkey ='7DT_C361K_HIGH_1x1'
dbrowser.filter = 'g'
target_imglist = dbrowser.search('calib*100.com.fits', 'science')
# %%
...
#all_catalog = Catalog('/home/hhchoi1022/data/scidata/7DT/7DT_C361K_HIGH_1x1/T01158/7DT15/g/calib_7DT15_T01158_20250210_075804_g_100.com.fits.cat', catalog_type = 'all', load = True)
#candidate_catalog = Catalog('/home/hhchoi1022/data/scidata/7DT/7DT_C361K_HIGH_1x1/T01158/7DT09/r/sub_coadd_calib_7DT09_T01158_20250207_074709_r_100.com_subframe_0.fits.transient', catalog_type = 'transient', load = True)
#%%
...
from ezphot.photometry import AperturePhotometry
AperturePhotometry = AperturePhotometry()
A = AperturePhotometry.circular_photometry(
...
#%%
from ezphot.photometry import PhotometricCalibration
PhotometricCalibration = PhotometricCalibration()
B = PhotometricCalibration.apply_zp(
    target_img = subframe_subtracted_img,
    target_catalog = A,
    save = True
)
