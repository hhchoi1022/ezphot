...
if __name__ == '__main__':
    helper = Helper()
    image = '/data/data1/factory_hhchoi/data/refdata/main/SkyMapper/SkyMapper_SG_32_Det_1x1/T01462/SkyMapper/r/DONE_SkyMapper_r_20180710091758-18_232.150-67.924_612x613.fits'
    C = ReferenceImage(image, telinfo = helper.get_telinfo('SkyMapper', 'SG_32_Det'))
