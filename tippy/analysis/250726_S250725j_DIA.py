...
def initialize_context():
    context = {}
    context['Preprocessor'] = TIPPreprocess()
    context['PlateSolver'] = TIPPlateSolve()
    context['MaskGenerator'] = TIPMasking()
    context['BkgGenerator'] = TIPBackground()
    context['ErrormapGenerator'] = TIPErrormap()
    context['AperturePhotometry'] = TIPAperturePhotometry()
    context['PSFPhotometry'] = TIPPSFPhotometry()
    context['PhotometricCalibration'] = TIPPhotometricCalibration()
    context['Stacking'] = TIPStacking()
    context['DIA'] = TIPSubtraction()
    context['sdt_data_querier'] = SDTData()
    context['Databrowser'] = TIPDataBrowser('scidata')
...
for tile_id in tile_ids:
    ...
    telinfo = context['helper'].estimate_telinfo(target_imglist[0].path)
    ...
    #             target_bkg, bkg_instance = context['BkgGenerator'].calculate_sep(
    #                 target_img = target_img,
    #                 target_mask = target_srcmask,
    #                 **config['bkg_kwargs'],
    #             )
    ...
    #                         **config['bkg_kwargs'],
    #                     )
    #                 target_bkgrms = context['ErrormapGenerator'].calculate_from_bkg(
