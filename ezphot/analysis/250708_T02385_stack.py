...
from ezphot.imageobjectsobjects import *
...
target_catalogs_all = [Catalog(path=target_catalogpath, catalog_type = 'all', load=True) for target_catalogpath in target_catalogpaths_all]
...
# %%
dataset = CatalogDataset(target_catalogs_all)
