...
catalog_sample = Catalog(target_img_sample.savepath.catalogpath, catalog_type = 'all')
...
from ezphot.catalog import Catalog
stacked_cataloglist = [Catalog(stacked_img.savepath.catalogpath, catalog_type = 'all') for stacked_img in stack_imglist]

cataloglist_gppy = glob.glob('/home/hhchoi1022/data/scidata/7DT/7DT_C361K_HIGH_1x1/T06911/*/*/*/*com.phot.cat')
stacked_cataloglist_gppy = [Catalog(catalog_path, catalog_type = 'all') for catalog_path in cataloglist_gppy]
...
dataset = CatalogDataset(stacked_cataloglist)
dataset_gppy = CatalogDataset(stacked_cataloglist_gppy)
