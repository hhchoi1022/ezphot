...
if __name__ == '__main__':
    ...
    target_imglist = databrowser.search(pattern = 'calib*20250424_031817*100.fits', return_type = 'science')
    target_img = target_imglist[0]
    target_cataloglist = databrowser.search(pattern = 'calib*20250424_031817*100.fits.cat', return_type = 'catalog')
