...
#%% Load the data
target_imgset = databrowser.search(pattern='Calib*60.fits', return_type='science')
...
# %%
result = stackprocess(reference_img)
# %%
...
from ezphot.dataobjects import Catalog
from ezphot.dataobjects import CatalogSet
catalogdataset_high = CatalogSet()
catalogdataset_merge = CatalogSet()
...
catalogdataset_all = CatalogSet(catalogdataset_high.catalogs + catalogdataset_merge.catalogs)
#%%
catalogdataset_kct = CatalogSet()
...
catalogdataset_all = CatalogSet(catalogdataset_all.catalogs + catalogdataset_kct.catalogs)
# %%
...
lc.plot(ra = 64.9729, dec= -54.948381, matching_radius_arcsec = 10, color_key = 'observatory', flux_key = 'MAGSKY_APER_1', fluxerr_key = 'MAGERR_APER_1')
# %%
lc.plt_params.figure_figsize = (10, 6)
lc.plt_params.xlim= [59500, 59750]
lc.plt_params.ylim = [20, 11]
lc.plot(ra = 64.9729, dec= -54.948381, matching_radius_arcsec = 10, color_key = 'filter', flux_key = 'MAGSKY_APER_1', fluxerr_key = 'MAGERR_APER_1')
# %%
