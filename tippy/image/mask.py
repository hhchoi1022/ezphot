...
if __name__ == '__main__':
    target_img = Path('/home/hhchoi1022/data/scidata/7DT/7DT_C361K_HIGH_1x1/T22956/7DT16/g/calib_7DT16_T22956_20250329_043218_g_100.fits.mask')
    sigma = 5
    ...
    self = Mask(path = target_img, load = True)
    #self.add_source_mask(target_img)#, sigma = sigma, mask_source_size_in_pixel = mask_source_size_in_pixel, print_output = print_output, visualize = visualize)  
