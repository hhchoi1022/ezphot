...
catalogdataset = TIPCatalogDataset(catalogs)
...
catalogdataset_all = TIPCatalogDataset(catalogdataset_high.catalogs)
#%%
...
catalogdataset_all = TIPCatalogDataset(catalogdataset_all.catalogs + catalogdataset_high.catalogs + catalogdataset_merge.catalogs)
# %%
