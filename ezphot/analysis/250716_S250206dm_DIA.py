...
transientcatalog_list = [Catalog(path = path, catalog_type = 'transient', load = True) for path in all_filepaths]
transientcatalog_dataset = CatalogDataset(transientcatalog_list)
