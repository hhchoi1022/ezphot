...
if __name__ == '__main__':
    #processed_path = '/data/data1/processed_1x1_gain2750/T00176/7DT02/m450/calib_7DT02_T00176_20250323_001429_m450_100.fits'
    target_img = Path('/home/hhchoi1022/data/scidata/7DT/7DT_C361K_HIGH_1x1/T22956/7DT02/m450/calib_7DT02_T22956_20250503_024858_m450_100.fits')
    mask_img = str(target_img) + '.mask'
    self = ScienceImage(target_img, telinfo = Helper().get_telinfo('7DT', 'C361K', 'HIGH', 1), load = True)
    #self.header = header
    # When it is used by other processes, the header should be updated.
    #self.load()
    # self.update_header(zp = 25)
    # self.header
    # self.save_info()
    # self.update_status('swarp')
    # self.save_status()
# %%
