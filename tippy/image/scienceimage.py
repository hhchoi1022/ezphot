    ...
    def __init__(self, path: str, telinfo : dict, status : Status = None):
        ...
        if os.path.exists(self.infopath):
            ...
            self.info = Info(PATH = path, OBSERVATORY =  self.telinfo['obs'], CCD = self.telinfo['ccd'],
                             ...
                             ALT = self.alt, AZ = self.az, RA = self.ra, DEC = self.dec, OBJNAME = self.objname, IMGTYPE = self.imgtype, FILTER = self.filter,
...
if __name__ == '__main__':
    path = '/home/hhchoi1022/data/scidata/7DT/7DT_C361K_HIGH_1x1/T03898/7DT02/m450/calib_7DT02_T03898_20240901_074507_m450_100.fits'
    processed_path = '/lyman/data1/processed_1x1_gain2750/T24807/7DT02/m450/calib_7DT02_T24807_20250130_080051_m450_300.com.fits'
    self = ScienceImage(processed_path, telinfo = Helper().get_telinfo('7DT', 'C361K', 'HIGH', 1))
# %%
