...
class TIPDataBrowser(Helper):
    ...
    def search(self, 
        ...
        -------
        dict or list
            If return_type is 'path', returns dict[telname] = file list or count.
            If return_type is object-based, returns list of image objects.
        """
        import glob
    ...
    def _get_default_path(self, foldertype):
        default_path_dict = {
            "scidata": self.config["SCIDATA_DIR"],
